<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="E_LTS.profile" MasterPageFile="~/E-LTS.Master" %>
    ...
    <div class="container">
        ...
        <table class="table" style="font-size: 16px;">
            <tr>
                ...
                <td>
                    <asp:Label ID="id" runat="server" Width="500px" Style="color: black;"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>Name : 
        ...
        <asp:Button ID="CancelButton" runat="server" Text="Cancel" CssClass="menuButton" />
