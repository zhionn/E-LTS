<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loan.aspx.cs" Inherits="E_LTS.Loan" MasterPageFile="~/E-LTS.Master" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="main" runat="server">
        ...
        <div class="card-body">
            ...
            <table class="tablePartA">
                <tr>
                    ...
                    <td style="width: 353px">
                        ...
                        <asp:Button ID="getButton1" runat="server" Text="Get" CssClass="getButton" OnClick="getButtonStudent_Click" CausesValidation="false" /><br />
                        ...
                        <asp:Label ID="failGetStudent" runat="server" CssClass="failMessage"></asp:Label>
                    </td>
            ...
            <table class="titleCodeLoan">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="getButtonCode" runat="server" Text="Get" CssClass="getButton" CausesValidation="false" OnClick="getButtonCode_Click" /><br />
                        ...
                        <asp:Label ID="failGet" runat="server" CssClass="failMessage"></asp:Label>
                    </td>
                </tr>
            </table>
            <!-- Item -->
            ...
            <table class="tablePartD">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="SupervisorEmail" runat="server" Width="400px" Height="40px"></asp:TextBox>
                        <asp:Button ID="getSuper" runat="server" Text="Get" CssClass="getButton" OnClick="getSuper_Click" CausesValidation="false" /><br />
    ...
    <div class="card shadow mb-4">
        <div
            class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h5 class="m-0 font-weight-bold text-primary" style="font-weight: bold; font-family: Arial">Section 2 : Loan
            <asp:Button ID="scan" runat="server" Text="🔍 Scan" OnClick="scan_Click" CssClass="scanButton" CausesValidation="false" /></h5>
            <asp:Button ID="load" runat="server" Text="↻ Load" CssClass="scanButton" OnClick="ImportCSV" CausesValidation="false" />
        </div>
        <div class="card-body">
            <asp:GridView ID="GridViewLoan" runat="server" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
            </asp:GridView>
            <asp:GridView ID="GridViewEmpty" runat="server" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
            </asp:GridView>
        </div>
    </div>
    <asp:Label ID="failNoti" runat="server" CssClass="failMessage"></asp:Label>
    ...
    <asp:Button ID="resetForm" class="menuButton" runat="server" Text="Reset" Style="margin-top: 10px; margin-left: 70px;" OnClick="resetForm_Click" CausesValidation="false" />
</asp:Content>
