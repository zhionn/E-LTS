<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_component.aspx.cs" Inherits="E_LTS.update_component" MasterPageFile="~/E-LTS.Master" MaintainScrollPositionOnPostback="true"%>
...
<link href="css/collapse.css" rel="stylesheet" />
     <div class="container">
    <h1 style="color:black;">Component Details</h1>
    <hr>
     <!-- STOCK CODE -->
        <table class="titleCodeUpdate">
            <tr>
                <td>
                    ...
                    <td>
                        <asp:TextBox ID="stock" runat="server" Width="530px" Height="40px" placeholder="Stock Code"></asp:TextBox>
      ...
      <asp:Button ID="updateButton" runat="server" Text="Update"  CssClass="menuButton" OnClick="updateButton_Click" style="margin-left:330px;"/>
