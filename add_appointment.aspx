<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_appointment.aspx.cs" Inherits="E_LTS.add_appointment" MasterPageFile="~/E-LTS.Master"%>
...
<link href="css/sb-admin-2.css" rel="stylesheet">
            ...
            <table class="tableRegister">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorQuantity1" runat="server" InitialValue="0" ErrorMessage="*Please Fill In Choose The Time" ControlToValidate="time" ForeColor ="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <asp:Button ID="AddButton" runat="server" Text="Add"  CssClass="addButton" OnClick="AddButton_Click"/>
     <asp:Button ID="ResetButton" runat="server" Text="Reset" class="resetButton" OnClick="ResetButton_Click" CausesValidation="false"/>
     <asp:Button ID="CancelButton" runat="server" Text="Cancel" CssClass="cancelButton" CausesValidation="false" OnClick="CancelButton_Click"/>
  </div>
</asp:Content>
